...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `statuspage` with the `NAME` of your provider.
...
before:
  ...
  - make tfgen
builds:
- binary: pulumi-resource-statuspage
  dir: provider
  goarch:
  - amd64
  - arm64
  ...
  ignore: []
  ldflags:
  - -X github.com/mortaelth/pulumi-statuspage-provider/provider/pkg/version.Version={{.Tag}}
  main: ./cmd/pulumi-resource-statuspage/
  sort: asc
  use: git
release:
  disable: false
...
├── config.yaml
├── metadata.json
├── pulumi-statuspage_darwin_amd64_v1
│   └── pulumi-resource-statuspage
├── pulumi-statuspage_darwin_arm64
│   └── pulumi-resource-statuspage
├── pulumi-statuspage_linux_amd64_v1
│   └── pulumi-resource-statuspage
├── pulumi-statuspage_linux_arm64
│   └── pulumi-resource-statuspage
├── pulumi-statuspage_windows_amd64_v1
│   └── pulumi-resource-statuspage.exe
└── pulumi-statuspage_windows_arm64
    └── pulumi-resource-statuspage.exe
```
